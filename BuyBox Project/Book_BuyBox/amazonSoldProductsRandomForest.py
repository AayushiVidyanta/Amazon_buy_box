...
Experiment 1
Considers the sellers of the Amazon sold products on the BOOK dataset
...
# Its columns are: 'Product ID', 'Rank', 'Seller', 'Price', 'Feedback Count', 'Price difference to the lowest', 'Price ratio to the lowest', 'Avg rating', 'Positive feedback', 'Fulfilled by Amazon?', 'Is Amazon the seller?', 'Does it win the buy box?', 'Number of Sellers' 
# ================================================================= FEATURES ============================================================================
...
# 6.  Price difference to the lowest: Difference of the price by the seller and the lowest price offered for the product among all competing sellers
# 7.  Price ratio to the lowest: Ratio of the price by the seller to the lowest price offered for the product among all the competing sellers
# 8.  Avg rating: Average rating of the seller
# 9.  Positive feedback: Positive feedback percentage of the seller
# 10. Fulfilled by Amazon?: 1 if the seller is fulfilled by amazon (FBA), else 0
# 11. Is Amazon the seller?: 1 if the seller is Cloudtail India or Appario Retail Private Ltd, else 0 
# 12. Does it win the buy box?: 1 if the seller wins the buy box for that product, else 0
# 13. Number of sellers: Total number of competing sellers for that product
# =======================================================================================================================================================
...
def preprocess_amazon_sold_products(mypath, amazonSold):
    ...
    for i in onlyfiles:
        ...
        l = l+1     
    #print(data)
    features = pd.DataFrame(data, columns=['Product ID', 'Rank', 'Seller', 'Price', 'Feedback Count', 'Price difference to the lowest', 'Price ratio to the lowest', 'Avg rating', 'Positive feedback', 'Fulfilled by Amazon?', 'Is Amazon the seller?', 'Does it win the buy box?', 'Number of Sellers'])
...
def main():
    ...
    X = features.iloc[:, [5, 6, 7, 8, 4, 9, 10]]
